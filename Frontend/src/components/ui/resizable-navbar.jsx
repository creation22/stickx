    ...
    <motion.div
      ...
      {items.map((item, idx) => (
        <a
          ...
          <span className="relative z-20" style={{ color: 'inherit' }}>{item.name}</span>
        </a>
      ))}
    </motion.div>
  );
...
export const NavbarLogo = () => {
  return (
    <a
      ...
      <img
        src="https://res.cloudinary.com/dlbe0tua7/image/upload/c_fit,w_256,h_256/f_auto/q_auto/v1/overlays/overlay1?_a=BAVAaqAQ0"
        alt="logo"
        width={30}
        height={30} />
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    primary:
      "bg-neutral-800 text-white shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]",
